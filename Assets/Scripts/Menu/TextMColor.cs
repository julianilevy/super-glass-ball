...
public class TextMColor : MonoBehaviour
{
    private Text _textColor;
    ...
    private void LerpColor(Color colorA, Color colorB, int nextColorStage)
    {
        colorA.a = 0.5f;
        colorB.a = 0.5f;
        _textColor.material.color = Color.Lerp(colorA, colorB, _colorRatio);
