...
public class GermanSpikedEnemy : Enemy
{
    ...
    public override void OnCollisionEnter(Collision collision)
    {
        ...
        {
            GermanSpikedEnemy hitGemanSpikedEnemy;
            hitGemanSpikedEnemy = collision.gameObject.GetComponentInParent<GermanSpikedEnemy>();

            if (hitGemanSpikedEnemy is GermanSpikedEnemy) hitGemanSpikedEnemy.TakeDamage(damage);
        }
